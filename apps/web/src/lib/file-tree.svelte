...
<ContextMenu.Root>
					...
					<li>
						{#if file.type === 'folder'}
							<details class="folder">
								...
								<svelte:self files={file.children} />
							</details>
						{:else}
							<span class="file flex">{file.name}</span>
						{/if}
					</li>
				{/each}
			</ul>
	...
	<ContextMenu.Content>
		<ContextMenu.Item>Create folder</ContextMenu.Item>
		<ContextMenu.Item on:click={createFile}>Create file</ContextMenu.Item>
	</ContextMenu.Content>
</ContextMenu.Root>
